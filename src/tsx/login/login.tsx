...
export class Login extends React.Component <Record<string, unknown>, LoginState>{
    state = {
        login: '',
        password: '',
    ...
    render(): JSX.Element {
        return <div className='loginBlock' data-testid='loginWrapper'>
            ...
            <button className='confirmBtn' data-testid='confirmButton' onClick={this.confirmButtonClick}>Confirm</button>
        </div>
    }
}