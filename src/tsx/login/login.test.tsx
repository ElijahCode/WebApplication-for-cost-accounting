...
describe('Testig Login Component', () => {
    ...
    it('Have wrapper block', () => {
        ...
        expect(screen.getByText('Enter login and password for enter in application')).toBeInTheDocument();
    })
    ...
    it('Warns when some input is empty and button is clicked', () => {
        ...
        expect((screen.getByTestId('inputForLogin') as HTMLInputElement).value).toBe("Tom");
        expect((screen.getByTestId('inputForPassword') as HTMLInputElement).value).toBe('');

        userEvents.click(screen.getByTestId('confirmButton'));
        ...
        expect((screen.getByTestId('inputForLogin') as HTMLInputElement).value).toBe("");
        expect((screen.getByTestId('inputForPassword') as HTMLInputElement).value).toBe('qwerty');
